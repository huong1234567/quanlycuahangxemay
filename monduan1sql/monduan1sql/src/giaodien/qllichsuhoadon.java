 ...
 * @author HP
 */
public class qllichsuhoadon extends javax.swing.JFrame {

    /**
     * Creates new form qllichsuhoadon
     */
    public qllichsuhoadon() {
        initComponents();
        loadls();
    }
...
LichSuHoaDonDAO dao = new LichSuHoaDonDAO();
   ...
   void insertls(){
       qlhoadon ql = new qlhoadon();
         LichSuHoaDon model = ql.getModelLS();
       try{
          daols .insert(model);
           this.loadls();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(qllichsuhoadon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new qllichsuhoadon().setVisible(true);
            }
        });
    }
